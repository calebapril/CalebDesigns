...
> [!NOTE]
> Please be advised that there are currently issues when using this application in other browser, like the background of the site can be white. For more information, refer to [](https://github.com/aliabb01/invoify/issues/11).
